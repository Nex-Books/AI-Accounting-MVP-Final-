...
function LoginForm() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const { data: userData } = await supabase.from('users').select('company_id').eq('id', authData.user.id).single();
...
_s(LoginForm, "FbRQsRjCcIhvOjEeE0NXu03UAA8=");
_c = LoginForm;
var _c;
...
//# sourceMappingURL=_918c5bd9._.js.map